...
var CartComponent = /** @class */ (function () {
    function CartComponent(cartService) {
        ...
        this.cartService.currentCartUpdate.subscribe(function (cart) {
            _this.currentCart = cart;
            _this.calcSubtotal(_this.currentCart);
        });
    }
    CartComponent.prototype.ngOnInit = function () {
        this.calcSubtotal(this.currentCart);
    };
    CartComponent.prototype.array = function (n) {
        return Array(n);
    };
    ...
    CartComponent.prototype.getSrc = function (product) {
    ...
    CartComponent.prototype.recalculate = function (cart) {
        this.calcSubtotal(cart);
    };
    CartComponent.prototype.calcSubtotal = function (cart) {
        var _this = this;
        this.subtotal = 0;
        cart.forEach(function (x) {
            _this.subtotal += x.cost * x.requiredQuantity;
        });
    };
...
var GalleryComponent = /** @class */ (function () {
    function GalleryComponent(firebaseService, activatedRoute, productService, router) {
        var _this = this;
        ...
        this.productList = [];
        this.lampsData = [];
        this.activatedRoute.queryParams.subscribe(function (x) {
            _this.firebaseService.getCategories(x["category"]).subscribe(function (data) {
                _this.productList = [];
    ...
    //   }
    // }
    GalleryComponent.prototype.display = function (product) {
    ...
    GalleryComponent.prototype.getSrc = function (product) {
        return product.imageCount > 0 ? './assets/Copy of Jared Inventory Project 3e_files/' + product.category + '/' + product.name + '_1.png' : './assets/images/rfoxbanner.jpg';
    };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(cartService, router, route) {
        var _this = this;
        this.cartService = cartService;
        this.router = router;
        this.route = route;
        ...
        router.events.subscribe(function (data) {
            if (data instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
                ...
                if (data.urlAfterRedirects.includes("home")) {
                    _this.transparentBackground = true;
                }
                else {
                    _this.transparentBackground = false;
                }
            }
        });
    }
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.cartService.cartSize.subscribe(function (itemsInCart) {
            _this.itemsInCart = itemsInCart;
        });
        this.menu = [
            {
                heading: "By Category",
    ...
    HeaderComponent.prototype.displayCart = function () {
        console.log("Current cart: ", this.cartService.currentCart);
        this.router.navigate(["/cart"], { relativeTo: this.route });
    };
    HeaderComponent.prototype.fetch = function (category) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, route, productService) {
        this.router = router;
        this.route = route;
        this.productService = productService;
        this.testimonials = [];
    ...
    HomeComponent.prototype.setCarousel = function () {
        this.featuredProducts = [
            {
    ...
    HomeComponent.prototype.displayCategory = function (category) {
    ...
    HomeComponent.prototype.setTestimonials = function () {
        this.testimonials = [
    ...
    HomeComponent.prototype.getSrc = function (product) {
        return product.imageCount > 0 ? './assets/Copy of Jared Inventory Project 3e_files/' + product.category + '/' + product.name + '_1.png' : './assets/images/rfoxbanner.jpg';
    };
...
var ProductPageComponent = /** @class */ (function () {
    function ProductPageComponent(cartService, activatedRoute) {
        var _this = this;
        this.cartService = cartService;
        this.activatedRoute = activatedRoute;
        this.itemQuantity = "0";
        this.activatedRoute.queryParams.subscribe(function (x) {
            _this.selectedProduct = JSON.parse(x['product']);
            _this.category = x['category'];
        });
    }
    ...
    ProductPageComponent.prototype.array = function (n) {
        return Array(n);
    };
    ...
    ProductPageComponent.prototype.setImgSrc = function (index) {
...
var CartService = /** @class */ (function () {
    function CartService() {
        ...
        if (JSON.parse(sessionStorage.getItem("currentCart"))) {
            ...
            setTimeout(function () {
                _this.cartSize.next(_this.cart.length);
                _this.currentCartUpdate.next(_this.cart);
            }, 50);
        }
    }
    CartService.prototype.addToCart = function (product) {
        // console.log(!this.cart.some(x => x.name == product.name));
        if (!this.cart.some(function (x) { return x.name == product.name; })) {
            this.cart.push(product);
        }
        else {
            var index = this.cart.findIndex(function (x) { return x.name == product.name; });
    ...
    Object.defineProperty(CartService.prototype, "currentCart", {
        get: function () {
            return this.cart;
        },
        enumerable: true,
    ...
    CartService.prototype.syncCart = function () {
...
var FirebaseService = /** @class */ (function () {
    ...
    FirebaseService.prototype.getCategories = function (category) {
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.setProduct = function (product) {
        this.selectedProduct = product;
        sessionStorage.setItem("selectedProduct", JSON.stringify(this.selectedProduct));
    };
    Object.defineProperty(ProductService.prototype, "product", {
        get: function () {
